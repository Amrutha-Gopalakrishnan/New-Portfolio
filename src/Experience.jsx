    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          whileHover={{ y: -6 }}
          className="relative rounded-2xl border border-white/10 bg-gradient-to-br from-white/5 to-white/0 backdrop-blur-xl p-6 sm:p-8 lg:p-10"
        >
          {/* View Certificate Button */}
          <button
            onClick={() => setOpen(true)}
            className="absolute top-4 right-4 sm:top-6 sm:right-6 flex items-center gap-2 text-sm text-gray-300 bg-white/5 px-4 py-2 rounded-full border border-white/10 hover:border-green-400 hover:text-green-400 transition"
          >
            View Certificate <ExternalLink size={14} />
          </button>

          <h3 className="text-2xl sm:text-3xl font-light text-green-400">
          ...
          <ul className="mt-6 space-y-3 text-gray-400 text-sm list-disc list-inside">
          ...
          <div className="flex flex-wrap gap-3">
            {[
              ...
              <motion.span
                ...
                className="px-4 py-2 rounded-full text-sm bg-white/5 border border-white/10 text-gray-300 hover:text-green-400 hover:border-green-400 transition"
              >
                {tech}
              </motion.span>
            ))}
